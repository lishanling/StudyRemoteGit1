...
<body>
	<div id="box">
			...
			<ul>
				...
				<li class="s">
					<form method="post">
						...
						<input type="button" onclick="searchall()" style="width: 50px; height: 40px; background-color: #F98235; border: solid 3px #F98235;
						 color: #fff; font-family: 微软雅黑; border-radius: 15px;" value="搜索" />
					</form>
				</li>
			</ul>
		</div>
		...
		<div id="sortdetail">
			<h3 style="font-size: 18px; color: #CDCDCD; margin-right: 400px;">您查询的结果如下：</h3>
			<br />
			<ul>
