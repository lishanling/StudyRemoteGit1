...
select  b.bid ,b.bname from book b inner join types s on s.ssid = b.ssid	where s.sname =  '名著' 

select  ssid from book;
--收藏表
...
select b.bname from book b inner join types t on t.sname = '学术'
 
select t.* from book b inner join types t on t.sname = '学术'
...
insert into menu values('第一章','有些话，羞于启齿','B10010','有些话，年轻的时候羞于启齿，等到张得开嘴时，已是人近中年，且远隔万重山水。 …… 每一年的大年初一，我都会收到一条同样的短信。在成堆的新年快乐恭喜发财的短信中，有杂草般短短的四字短信：哥，好好的。 很多个大年初一，我收到那条四字短信后，都想回复一条长长的短信……可最终都只回复四个字了事：乖，摸摸头。……');
insert into menu values('第二章','我有一碗酒，可以慰风尘','B10010','我写这篇文章并未征得老兵的同意，我也做好了被他扔下河的准备。 无他，在这个不懂得反思的时代，有些故事应该被后人知晓。 不奢望铭记，知晓即可。 有庙堂正史，亦应有民间修史，何为史？末学浅见，五个字：真实的故事。 是对是错，是正是反，百年后世人自有分晓，但无论如何，请别让它湮没，那些鲜活和真实的细节，有…');
insert into menu values('第三章','对不起','B10010','她哭着喊：对不起，对不起，对不起…… 它贴在地面上的脑袋猛地抬了一下，好像意识到了些什么，脖子开始拼命地使劲，努力地想回头看她一眼，腿使劲尾巴使劲全身都在使劲…… 终究没能回过头来。 白瓷盆里空空的，今天她还没来得及喂它吃东西。……');
